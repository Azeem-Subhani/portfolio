          ...
          <div className="row">
            <div className="col-12">
              <div className="skill-bx wow zoomIn">
                <h2>Skills</h2>
                <p>
                  I'm a software engineer skilled in cross-platform development
                  with React Native and Ionic. Proficient in HTML5, CSS3, Sass,
                  JavaScript, React.js, Vue.js, Node.js, SQL, AWS, and
                  serverless architecture, I deliver end-to-end solutions for
                  innovative, scalable applications.
                </p>
                <div className="flex flex-col lg:flex-row">
                  <Lottie options={defaultOptions} height={window.innerWidth > 1024 ? 400 : 300} width={window.innerWidth > 1024 ? 600 : 300} />
